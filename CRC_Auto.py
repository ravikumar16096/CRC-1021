def CRC(data):
    ...
    #Call above function
    #requestData = str(f)
    #data='A0 47 00 02 04 01 41 10'
    dataL=data.split()
    requestData =''.join(dataL)                                     
    lengthOfHexCRC = 4
    strChecksum = GetFormattedHex(GetCrc16(requestData), lengthOfHexCRC)
    #print(strChecksum)
    act1=strChecksum[0:2]
    act2=strChecksum[2:4]
    Actual=act2+act1
    #print("actual Checksum:",Actual)
    return Actual
if __name__=="__main__":
    print(CRC('A0 47 00 02 04 01 41 10'))
